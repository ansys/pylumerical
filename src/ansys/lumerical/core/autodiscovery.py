...
def locate_lumerical_install():
    ...
    Examples:
        ...
        >>> ansys.api.lumerical.lumapi.InteropPaths.setLumericalInstallPath("C:\\Program Files\\Lumerical\\v252\\")
        >>> import ansys.lumerical.core as lumapi
        >>> # use lumapi ...
        ...
        >>> lumapi.InteropPaths.setLumericalInstallPath("C:\\Program Files\\Lumerical\\v252\\")
        >>> # use lumapi ...        
    """
    ...
    for guess_base, suffix in guess_base_and_suffix:
        if os.path.exists(guess_base):
            for dir in os.listdir(guess_base):
                if os.path.isdir(os.path.join(guess_base, dir, suffix)):
                    ...
                    if match:
                        ...
                        if ver_year > latest_ver_year or (ver_year == latest_ver_year and ver_maj > latest_ver_release):
                            ...
                            if os.path.exists(os.path.join(guess_base, dir, suffix, "api/python/")):
                                lumerical_install_dir = os.path.join(guess_base, dir, suffix)
