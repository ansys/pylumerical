...
with lumapi.FDTD() as fdtd:
  print(f"Welcome to Lumerical FDTD {fdtd.version()}!")
...
with lumapi.FDTD(hide=True) as fdtd:
  print(f"Welcome to Lumerical {fdtd.version()}!")
```
...
with lumapi.FDTD(hide=True) as fdtd:
  ...
  # Add a CPU resource called "PyLum CPU"
  fdtd.setresource("FDTD", resourceNum, "device type", "CPU")
  fdtd.setresource("FDTD", "name", "PyLum CPU")
  # Add a GPU resource called "PyLum GPU"
  fdtd.setresource("FDTD", resourceNum, "device type", "GPU")
  fdtd.setresource("FDTD", "name", "PyLum GPU")
```
...
with lumapi.FDTD() as fdtd:
  ...
  fdtd.run("FDTD", "GPU", f"PyLum GPU") # Run GPU solver on the PyLum GPU resource
```
...
```{python}
with lumapi.FDTD() as fdtd:
  burstSettings={"account": "user@company.com:", "download": True, "Name": "MyPyLumBurstJob"}
