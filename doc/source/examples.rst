...
.. grid:: 2 2 3 3
   ...
   .. grid-item-card:: Session management
      ...
      Download the example :examples_url:`here <Sessions%20and%20Objects/basic_session_management.py>`.
   ...
   .. grid-item-card:: Basic FDTD simulation - Lumerical style commands
      ...
      Download the example :examples_url:`here <Sessions%20and%20Objects/fdtd_example1_lsf.py>`.
