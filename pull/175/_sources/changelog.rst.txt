...
`0.4.0 <https://github.com/ansys/pylumerical/releases/tag/v0.4.0>`_ - August 28, 2026
=====================================================================================
...
.. tab-set::
  ...
  .. tab-item:: Added
    ...
    .. list-table::
        ...
        * - Add PR migrator workflow
          - `#129 <https://github.com/ansys/pylumerical/pull/129>`_
  ...
  .. tab-item:: Fixed
    ...
    .. list-table::
        ...
        * - License classifier
          - `#163 <https://github.com/ansys/pylumerical/pull/163>`_
  ...
  .. tab-item:: Documentation
    ...
    .. list-table::
        ...
        * - Update \`\`CONTRIBUTORS.md\`\` with the latest contributors
          - `#132 <https://github.com/ansys/pylumerical/pull/132>`_

        * - Example- metalens updates
          - `#134 <https://github.com/ansys/pylumerical/pull/134>`_

        * - Example- HEAT thermal waveguide tuner getting started example (migrated (PR 69))
          - `#135 <https://github.com/ansys/pylumerical/pull/135>`_

        * - Getting started page improvement
          - `#136 <https://github.com/ansys/pylumerical/pull/136>`_

        * - External contributor update
          - `#137 <https://github.com/ansys/pylumerical/pull/137>`_

        * - Lumerical 2026 R1.3 documentation update
          - `#142 <https://github.com/ansys/pylumerical/pull/142>`_

        * - Example - lumopt2 Y branch
          - `#148 <https://github.com/ansys/pylumerical/pull/148>`_

        * - Added example for lumopt2 parameter tracking
          - `#152 <https://github.com/ansys/pylumerical/pull/152>`_

        * - Fix vale errors
          - `#154 <https://github.com/ansys/pylumerical/pull/154>`_

        * - Address feedback for lumopt2 documentation
          - `#156 <https://github.com/ansys/pylumerical/pull/156>`_
  ...
  .. tab-item:: Dependencies
    ...
    .. list-table::
        ...
        * - Bump the pip-deps group across 1 directory with 4 updates
          - `#124 <https://github.com/ansys/pylumerical/pull/124>`_

        * - Bump jupytext from 1.19.4 to 1.19.5 in the pip-deps group
          - `#145 <https://github.com/ansys/pylumerical/pull/145>`_

        * - Update flit-core requirement from <4,>=3.2 to >=3.2,<5 in the pip-deps group
          - `#158 <https://github.com/ansys/pylumerical/pull/158>`_
  ...
  .. tab-item:: Maintenance
    ...
    .. list-table::
        ...
        * - Update CHANGELOG for v0.3.0
          - `#111 <https://github.com/ansys/pylumerical/pull/111>`_

        * - Bump dev version to 0.4.dev0
          - `#112 <https://github.com/ansys/pylumerical/pull/112>`_

        * - Cleanup CONTRIBUTING.md
          - `#113 <https://github.com/ansys/pylumerical/pull/113>`_

        * - Bump actions/checkout from 6.0.2 to 6.0.3 in the actions group
          - `#114 <https://github.com/ansys/pylumerical/pull/114>`_

        * - Bump the actions group across 1 directory with 2 updates
          - `#125 <https://github.com/ansys/pylumerical/pull/125>`_

        * - Bump the actions group across 1 directory with 5 updates
          - `#144 <https://github.com/ansys/pylumerical/pull/144>`_

        * - Update Lumerical unified Docker image to version v261_3
          - `#147 <https://github.com/ansys/pylumerical/pull/147>`_

        * - Update missing or outdated files
          - `#157 <https://github.com/ansys/pylumerical/pull/157>`_

        * - Bump the actions group across 1 directory with 4 updates
          - `#160 <https://github.com/ansys/pylumerical/pull/160>`_
  ...
  .. tab-item:: Test
    ...
    .. list-table::
        ...
        * - PyLumerical Integration Testing
          - `#14 <https://github.com/ansys/pylumerical/pull/14>`_
